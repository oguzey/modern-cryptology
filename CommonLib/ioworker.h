...
public:
	...
	static void write_to_file(std::vector<uint16_t> &a_input, const char *a_filename);
	static size_t convert2unit16_t(const std::vector<uint8_t> &a_in,
											 std::vector<uint16_t> &a_out);
